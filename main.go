...
func main() {
	...
	flag.StringVar(&pluginPath, "registry", "E:/Programing/Terraform/.terraform/providers/registry.terraform.io/telmate/proxmox", "specify path, useful for local debugging")
	flag.Parse()
